...
class IgBLASTReader:
    ...
    # IgBLAST CDR3 fields
    _igblast_cdr3_fields = ['IGBLAST_CDR3_NT','IGBLAST_CDR3_AA']
    ...
    def _parseIgBLASTCDR3(chunk):
        ...
        cdr3_map = {'nucleotide sequence': 'IGBLAST_CDR3_NT',
                    'translation': 'IGBLAST_CDR3_AA'}
    ...
    def parseBlock(self, block):
        ...
        chunk_map = {'query': ('# Query:', self._parseQueryChunk),
                     ...
                     'subregion': ('# Sub-region sequence details', self._parseIgBLASTCDR3),
